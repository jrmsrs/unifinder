...
<svelte:head>
	<title>Perfil Privado - UniFinder</title>
...
<div class="mx-auto max-w-4xl space-y-6 p-4">
	...
	{#if form?.error}
		<Alert color="red" dismissable class="flex items-center space-x-2">
			<ExclamationTriangle class="h-5 w-5" />
	...
	>
		<TabItem open class="flex items-center space-x-2">
			<User class="h-4 w-4" />
					...
					>
						<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
							...
							<div class="md:col-span-2">
								...
								<Input
									id="email"
									value={profile?.email || data.user?.email || ''}
									readonly
		...
		<TabItem class="flex items-center space-x-2">
